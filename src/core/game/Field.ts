...
export default class Field {
    ...
    setContent(plant: Nullable<Plant> = null): Nullable<Plant> {
        ...
        if (oldPlant) {
            ...
            oldPlant.game.fieldPlantMutationEventDispatcher.dispatch(new FieldPlantMutationEvent(this, oldPlant, MutationType.REMOVED));
        }
        this.plant = plant;
        if (plant) {
            plant.onAddToField(this);
            plant.game.fieldPlantMutationEventDispatcher.dispatch(new FieldPlantMutationEvent(this, plant, MutationType.ADDED));
        }
        return oldPlant;
    }
}